...
export const manualAlternatives: Alternative[] = [
  {
    ...
    openSourceAuditUrl: 'https://github.com/orgs/tutao/repositories',
  ...
  },
  {
    ...
    isOpenSource: true,
    openSourceLevel: 'partial',
    openSourceAuditUrl: 'https://docs.mistral.ai/getting-started/models/models_overview/',
  ...
  },
  {
    ...
    isOpenSource: true,
    openSourceLevel: 'partial',
    openSourceAuditUrl: 'https://f-droid.org/en/packages/com.infomaniak.euria/',
    ...
    license: 'GPL-3.0 (mobile clients); proprietary AI backend',
  },
  {
    id: 'qwant',
    name: 'Qwant',
  ...
  },
  {
    ...
    name: 'Nextcloud Talk',
    description:
      'Self-hosted video conferencing and team chat built into the Nextcloud platform. Supports HD video calls, screen sharing, breakout rooms, webinar recording, and end-to-end encrypted calls. Requires a Nextcloud server installation — it cannot run standalone — but integrates tightly with Nextcloud Files and Groupware for a unified collaboration workspace.',
    localizedDescriptions: {
      de: 'Selbst gehostete Videokonferenz- und Team-Chat-Lösung, integriert in die Nextcloud-Plattform. Unterstützt HD-Videoanrufe, Bildschirmfreigabe, Breakout-Räume, Webinar-Aufzeichnung und Ende-zu-Ende-verschlüsselte Anrufe. Erfordert eine Nextcloud-Server-Installation — kann nicht eigenständig betrieben werden — integriert sich aber nahtlos mit Nextcloud Files und Groupware zu einem einheitlichen Arbeitsbereich.',
    },
    ...
    isOpenSource: true,
    openSourceLevel: 'full',
    sourceCodeUrl: 'https://github.com/nextcloud/spreed',
    pricing: 'free',
    selfHostable: true,
    tags: ['meeting-software', 'videoconferencing', 'webrtc', 'open-source', 'self-hosting', 'e2ee', 'encryption', 'federated', 'privacy', 'gdpr'],
    foundedYear: 2016,
    headquartersCity: 'Stuttgart',
    license: 'AGPL-3.0 (server + desktop); GPL-3.0 (mobile clients)',
  },
  {
    id: 'olvid',
    ...
    isOpenSource: true,
    openSourceLevel: 'partial',
    openSourceAuditUrl: 'https://github.com/orgs/olvid-io/repositories',
  ...
  },
  {
    ...
    pricing: 'free',
    tags: ['mail-client', 'open-source', 'local-first', 'local', 'imap', 'pop3', 'smtp', 'privacy', 'outlook'],
    foundedYear: 2003,
  ...
  },
  {
    ...
    isOpenSource: true,
    openSourceLevel: 'full',
    openSourceAuditUrl: 'https://github.com/twofas/2fas-server',
  ...
  },
  {
    ...
    isOpenSource: true,
    openSourceLevel: 'partial',
    openSourceAuditUrl: 'https://www.raspberrypi.com/software/',
  ...
  },
  {
    ...
    logo: '/logos/mangopay.svg?v=20260224',
    country: 'lu',
    category: 'payments',
    replacesUS: ['Stripe', 'PayPal', 'Square'],
    isOpenSource: false,
  ...
  },
  {
    ...
    pricing: 'freemium',
    selfHostable: true,
    tags: ['smart-home', 'home-automation', 'open-source', 'local-first', 'local', 'self-hosting'],
    license: 'Apache-2.0',
  },
  {
    id: 'haiilo',
  ...
  },
  {
    ...
    pricing: 'free',
    selfHostable: true,
    tags: ['smart-home', 'home-automation', 'open-source', 'self-hosted', 'local-control', 'local'],
    license: 'EPL-2.0',
  },
  {
    id: 'linux-kernel',
  ...
  },
  {
    ...
    pricing: 'freemium',
    selfHostable: true,
    tags: ['messaging', 'matrix', 'decentralized', 'e2ee', 'encryption', 'federation', 'federated', 'voice', 'video', 'open-standard', 'self-hosting'],
    foundedYear: 2017,
    headquartersCity: 'London',
    license: 'AGPL-3.0',
  },
  {
    ...
    pricing: 'free',
    selfHostable: true,
    tags: ['meeting-software', 'videoconferencing', 'webrtc', 'open-source', 'self-hosting', 'e2ee', 'encryption'],
  ...
  },
  {
    ...
    isOpenSource: true,
    openSourceLevel: 'partial',
    openSourceAuditUrl: 'https://zeitkapsl.eu/en/about/',
    sourceCodeUrl: 'https://codeberg.org/zeitkapsl/zeitkapsl',
    pricing: 'paid',
    tags: ['images', 'photo', 'cloud', 'storage', 'privacy', 'e2ee', 'encryption'],
    headquartersCity: 'Vienna',
    license: 'GPL-3.0 (clients/core); proprietary server',
  },
  {
    id: 'vaultwarden',
    name: 'Vaultwarden',
  ...
  },
  {
    ...
    pricing: 'free',
    tags: ['2fa', 'authenticator', 'open-source', 'local-app', 'local', 'wearos'],
  ...
  },
  {
    ...
    openSourceLevel: 'none',
    pricing: 'paid',
    tags: ['encryption', 'privacy', 'gdpr', 'zero-access', 'zero-knowledge', 'ad-free', 'ai'],
    foundedYear: 2016,
    headquartersCity: 'Vienna',
    reservations: [
      {
  ...
  },
  {
    ...
    isOpenSource: true,
    openSourceLevel: 'full',
    openSourceAuditUrl: 'https://internxt.com/open-source',
    ...
    reservations: [
      {
        ...
        severity: 'moderate',
        date: '2025-02-01',
        sourceUrl: 'https://github.com/internxt/cli/issues/384',
      },
      {
        ...
        severity: 'moderate',
        sourceUrl: 'https://www.experte.com/cloud-storage/internxt',
      },
    ],
  },
  {
    ...
    reservations: [
      {
        ...
        severity: 'major',
        sourceUrl: 'https://docs.jottacloud.com/en/articles/1292923-does-jottacloud-support-private-encryption-keys',
      },
      {
      ...
      },
      {
        ...
        severity: 'minor',
        sourceUrl: 'https://docs.jottacloud.com/en/articles/3271114-reduced-upload-speed',
      },
    ],
  },
  {
    ...
    name: 'Rclone',
    description:
      'Mature, open-source command-line tool for syncing files to and from over 70 cloud storage providers. Often called "rsync for cloud storage", rclone enables users to manage data across multiple providers with encryption, compression, and mounting capabilities. Fully self-hostable as users control which cloud providers they connect to.',
    localizedDescriptions: {
      de: 'Ausgereiftes, quelloffenes Kommandozeilen-Tool zur Synchronisation von Dateien mit über 70 Cloud-Speicheranbietern. Oft als "rsync für Cloud-Speicher" bezeichnet, ermöglicht rclone das Verwalten von Daten über mehrere Anbieter mit Verschlüsselung, Komprimierung und Mount-Funktionen. Vollständig selbst-hostbar, da Benutzer kontrollieren, welche Cloud-Anbieter sie nutzen.',
    },
    website: 'https://rclone.org',
    logo: '/logos/rclone.svg',
    country: 'gb',
    category: 'cloud-storage',
    replacesUS: ['Google Drive', 'Dropbox', 'iCloud', 'OneDrive'],
    isOpenSource: true,
    openSourceLevel: 'full',
    sourceCodeUrl: 'https://github.com/rclone/rclone',
    pricing: 'free',
    selfHostable: true,
    tags: ['cloud-storage', 'sync', 'backup', 'cli', 'open-source', 'encryption', 'multi-cloud'],
    foundedYear: 2014,
  ...
  },
  {
    ...
    openSourceLevel: 'none',
    pricing: 'freemium',
    tags: ['password-manager', 'passwordless', 'privacy', 'gdpr', 'e2ee', 'encryption', 'iso-27001'],
    foundedYear: 2018,
    ...
    reservations: [
      {
        ...
        severity: 'moderate',
        sourceUrl: 'https://www.heylogin.com/en/whitepaper',
      },
      {
        ...
        severity: 'minor',
        sourceUrl: 'https://www.heylogin.com/en/login-devices',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    openSourceLevel: 'none',
    pricing: 'free',
    tags: ['maps', 'navigation', 'privacy', 'offline-maps', 'offline'],
    foundedYear: 2016,
  ...
  },
  {
    ...
    isOpenSource: true,
    openSourceLevel: 'partial',
    openSourceAuditUrl: 'https://opentalk.eu/en/product',
  ...
  },
  {
    ...
    pricing: 'free',
    tags: ['messaging', 'e2ee', 'encryption', 'privacy', 'decentralized', 'anti-censorship', 'gdpr'],
    foundedYear: 2021,
    headquartersCity: 'London',
    license: 'AGPL-3.0',
  },
  ...
  },
  {
    ...
    pricing: 'freemium',
    selfHostable: true,
    tags: ['project-management', 'collaboration', 'wiki', 'knowledge-base', 'self-hosted', 'decentralized', 'e2ee', 'local-first'],
    foundedYear: 2018,
    headquartersCity: 'Zug',
    license: 'MIT (protocol); ASAL (clients)',
    trustScoreStatus: 'pending',
  },
  {
    id: 'postgresql',
    name: 'PostgreSQL',
    description:
      'Open-source object-relational database maintained by the PostgreSQL Global Development Group. The project adopted the PostgreSQL name in 1996 and is released under the PostgreSQL License.',
    localizedDescriptions: {
      de: 'Quelloffene objekt-relationale Datenbank, gepflegt von der PostgreSQL Global Development Group. Das Projekt führte 1996 den Namen PostgreSQL ein und steht unter der PostgreSQL-Lizenz.',
    },
    website: 'https://www.postgresql.org',
    logo: '/logos/postgresql.svg',
    country: 'eu',
    category: 'databases',
    replacesUS: ['Oracle Database', 'Microsoft SQL Server', 'Amazon RDS', 'Google Cloud SQL', 'Azure SQL Database'],
    isOpenSource: true,
    openSourceLevel: 'full',
    openSourceAuditUrl: 'https://www.postgresql.org/about/licence/',
    sourceCodeUrl: 'https://git.postgresql.org/git/postgresql.git',
    pricing: 'free',
    selfHostable: true,
    tags: ['database', 'relational-database', 'sql', 'open-source', 'self-hosted'],
    foundedYear: 1996,
    headquartersCity: 'PostgreSQL Global Development Group',
  ...
  },
  {
    ...
    name: 'MariaDB Server',
    description:
      'Community-developed relational database fork created by original MySQL developers. MariaDB\'s first stable release was published in October 2009, and MariaDB Server remains open source under GPLv2.',
    localizedDescriptions: {
      de: 'Community-getragener relationaler Datenbank-Fork, gestartet von ursprünglichen MySQL-Entwicklern. Die erste stabile MariaDB-Version wurde im Oktober 2009 veröffentlicht; MariaDB Server bleibt unter GPLv2 quelloffen.',
    },
    ...
    isOpenSource: true,
    openSourceLevel: 'full',
    openSourceAuditUrl: 'https://mariadb.org/about/',
    sourceCodeUrl: 'https://github.com/MariaDB/server',
    pricing: 'free',
    selfHostable: true,
    tags: ['database', 'relational-database', 'sql', 'open-source', 'self-hosted'],
    foundedYear: 2009,
  ...
  },
  {
    ...
    name: 'DuckDB',
    description:
      'Open-source in-process analytical SQL database for OLAP workloads. The DuckDB Foundation states the project is MIT-licensed with no enterprise version and is incorporated in the Netherlands.',
    localizedDescriptions: {
      de: 'Quelloffene In-Process-Analyse-SQL-Datenbank für OLAP-Workloads. Laut DuckDB Foundation ist das Projekt MIT-lizenziert, ohne Enterprise-Version, und in den Niederlanden eingetragen.',
    },
    website: 'https://duckdb.org',
    logo: '/logos/duckdb.svg',
    country: 'nl',
    category: 'databases',
    replacesUS: ['Google BigQuery', 'Snowflake', 'Amazon Redshift'],
    isOpenSource: true,
    openSourceLevel: 'full',
    openSourceAuditUrl: 'https://duckdb.org/faq.html',
    sourceCodeUrl: 'https://github.com/duckdb/duckdb',
    pricing: 'free',
    selfHostable: true,
    tags: ['database', 'analytical-database', 'olap', 'sql', 'in-process', 'open-source'],
    license: 'MIT',
  },
  {
    id: 'mysql-community',
    ...
    description:
      'Open-source relational database distributed as MySQL Community Edition under GPL. Oracle documents Community Edition as open source, with source code available in the mysql/mysql-server repository.',
    localizedDescriptions: {
      de: 'Quelloffene relationale Datenbank, bereitgestellt als MySQL Community Edition unter GPL. Oracle dokumentiert die Community Edition als Open Source; der Quellcode ist im Repository mysql/mysql-server verfügbar.',
    },
    website: 'https://www.mysql.com/products/community/',
    logo: '/logos/mysql-community.svg',
    country: 'us',
    category: 'databases',
    replacesUS: ['Oracle Database', 'Microsoft SQL Server', 'Amazon RDS', 'Google Cloud SQL', 'Azure SQL Database'],
    isOpenSource: true,
    openSourceLevel: 'full',
    openSourceAuditUrl: 'https://www.mysql.com/products/community/',
    sourceCodeUrl: 'https://github.com/mysql/mysql-server',
    pricing: 'free',
    selfHostable: true,
    tags: ['database', 'relational-database', 'sql', 'open-source', 'self-hosted'],
    license: 'GPL-2.0',
